var GeoIntersectAntiDiagonal;
GeoIntersectAntiDiagonal = (function () {
    function GeoIntersectAntiDiagonal(mover,isFirstPoint){
        this.mover = mover;
        this.isFirstPoint = isFirstPoint;
    }
    Object.defineProperties(GeoIntersectAntiDiagonal.prototype,{
        'getDirection':{
            writable:false,
            enumerable:false,
            value:function (rect) {
    ...
    return GeoIntersectAntiDiagonal;
})();